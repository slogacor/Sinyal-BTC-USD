...
import nest_asyncio  # ⬅️ Diperlukan untuk patch loop
nest_asyncio.apply()
...
# === DATA DUMMY UNTUK CANDLE (bisa diganti API asli) ===
...
if __name__ == "__main__":
    ...
    async def run():
        asyncio.create_task(periodic_signal())
